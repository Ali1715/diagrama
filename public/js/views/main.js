...
linkTypeSelect.addEventListener('change', function(event) {
  var selectedLinkType = event.target.value;
  updateDefaultLinkType(selectedLinkType);
});

function updateDefaultLinkType(selectedLinkType) {
  var linkType = joint.shapes.uml[selectedLinkType];
  paper.options.defaultLink = new linkType();
}
*/
