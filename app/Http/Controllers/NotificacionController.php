...
class NotificacionController extends Controller
{
    ...
    public function notificar(Request $request)
    {
        try {
            ...
            $notificacion->contenido = auth()->user()->name . ' te esta invitando a unirte a su equipo: ' . $proyecto->nombre . ' como colaborador...Tu equipo te necesita\nIngresa con tu correo actual, tu contrasena es: '.$pass;
            ...
            $email = [
                'subject' => 'Inivitacion Equipo: ' . $proyecto->nombre,
                'saludo' => 'Hola que tal ' . $user->name,
                'contenido' => $notificacion->contenido,
                'botonTexto' => 'Ingresar',
                'url' => $url,
                'nota' => 'Al ingresar al equipo podras participar en todas los distintos diagramas sobre los que tu equipo te permitira trabajar'
            ];
    ...
    public function store(Request $request)
    {
        try {
            ...
            $proyecto = Proyecto::find($request->proyecto_id);
            $notificacion = new Notificacion;
            $notificacion->contenido = auth()->user()->name . ' te esta invitando al equipo: ' . $proyecto->nombre . ' como colaborador...Tu equipo te necesita';
